...
/**
 * 統合テストを実行するためのクラスです。
 * <p>（このクラスはmaven-surefire-pluginのソースコードを元に書かれました。）
 *
...
public class IntegrationTestMojo extends AbstractMojo
{
     ...
     *
     * @parameter expression="${maven.it.skip}"
     */
     ...
     *
     * @parameter expression="${project.build.directory}/surefire-it-reports"
     */
     ...
     * @parameter
     */
    private String testLibraries;

    /**
     * @parameter
     */
    private String additionalTestLibraries;
        ...
        try {
            ...
            if (testNgArtifact != null) {
                ...
                if (junitArtifact != null) {
                    addProvider(surefireBooter, "surefire-junit",
            ...
            if (test != null) {
                ...
                if (includes == null || includes.size() == 0) {
                    includes = new ArrayList(Arrays
                        .asList(new String[] { "**/*IT.java" }));
                }
                if (excludes == null || excludes.size() == 0) {
                    excludes = new ArrayList(Arrays.asList(new String[] {
                        "**/Abstract*IT.java", "**/Abstract*TestCase.java",
                        "**/*$*" }));
                }
            }
    ...
    void constructClasspathElements()
        ...
        throws ArtifactResolutionException, ArtifactNotFoundException
    {
        ...
        return artifactResolver.resolveTransitively(Collections
            .singleton(providerArtifact), originatingArtifact, localRepository,
    ...
    protected void processSystemProperties(boolean setInSystem)
    {
        ...
        systemProperties.setProperty("localRepository", localRepository
            .getBasedir());
